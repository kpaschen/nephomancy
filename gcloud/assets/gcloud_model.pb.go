...
func (x *GCloudNetwork) GetAddresses() []*GCloudIpAddress {
	if x != nil {
		return x.Addresses
	}
	return nil
...
func (x *GCloudIpAddress) Reset() {
	*x = GCloudIpAddress{}
	if protoimpl.UnsafeEnabled {
		mi := &file_gcloud_model_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *GCloudIpAddress) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GCloudIpAddress) ProtoMessage() {}

func (x *GCloudIpAddress) ProtoReflect() protoreflect.Message {
	mi := &file_gcloud_model_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GCloudIpAddress.ProtoReflect.Descriptor instead.
func (*GCloudIpAddress) Descriptor() ([]byte, []int) {
	return file_gcloud_model_proto_rawDescGZIP(), []int{4}
}

func (x *GCloudIpAddress) GetType() string {
	if x != nil {
		return x.Type
	}
	return ""
...
func (x *GCloudIpAddress) GetNetwork() string {
	if x != nil {
		return x.Network
	}
	return ""
...
func (x *GCloudIpAddress) GetRegion() string {
	if x != nil {
		return x.Region
	}
	return ""
...
func (x *GCloudIpAddress) GetPurpose() string {
	if x != nil {
		return x.Purpose
	}
	return ""
...
func (x *GCloudIpAddress) GetStatus() string {
	if x != nil {
		return x.Status
	}
	return ""
...
func (x *GCloudIpAddress) GetEphemeral() bool {
	if x != nil {
		return x.Ephemeral
	}
	return false
...
var file_gcloud_model_proto_rawDesc = []byte{
	...
	,
...
var file_gcloud_model_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_gcloud_model_proto_goTypes = []interface{}{
	...
	(*GCloudIpAddress)(nil),  // 4: model.GCloudIpAddress
}
var file_gcloud_model_proto_depIdxs = []int32{
	4, // 0: model.GCloudNetwork.addresses:type_name -> model.GCloudIpAddress
...
func file_gcloud_model_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_gcloud_model_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GCloudIpAddress); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
